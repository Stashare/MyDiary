// Turn off rounded corners and shadows on text fields and buttons
$(document).on( "mobileinit", function() {
  $.mobile.textinput.prototype.options.corners = false;
...
$(document).on( 'pagecreate', '#listTodos', function() {
