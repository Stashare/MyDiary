...
if ( !in_array( $action, array( 'login', 'logout', 'signup', 'sendPassword', 'newTodo', 'editTodo', 'deleteTodo', 'changeTodoStatus', 'options', 'deleteCompleted', 'changePassword' ), true ) ) $action = 'listTodos';
$action();
